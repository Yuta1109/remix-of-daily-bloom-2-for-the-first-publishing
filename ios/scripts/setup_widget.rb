...
token_uploader_path = File.expand_path("App/LiveActivities/LiveActivityTokenUploader.swift", Dir.pwd)
...
token_uploader_ref = ref_for(project, la_group, token_uploader_path, "LiveActivityTokenUploader.swift")

app_sources = app_target.source_build_phase
[attributes_ref, plugin_ref, token_center_ref, refresh_center_ref, apns_cache_ref, token_uploader_ref].each do |ref|
