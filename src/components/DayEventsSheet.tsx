    ...
    <DrawerPrimitive.Root open={open} onOpenChange={onOpenChange} shouldScaleBackground={false}>
      <DrawerPrimitive.Portal>
        ...
        <DrawerPrimitive.Content
          className="fixed inset-x-0 bottom-0 z-50 flex flex-col rounded-t-2xl border bg-background max-h-[65vh] min-h-0 overflow-hidden outline-none"
        ...
        >
          ...
          {/* Same native scroll pattern as EventSheet (pre–scrollbar-inset). */}
          <div
            className="event-sheet-scroll min-h-0 overflow-y-scroll overscroll-contain px-4 py-3 space-y-2"
            style={{ flex: "1 1 0%" }}
            data-vaul-no-drag=""
