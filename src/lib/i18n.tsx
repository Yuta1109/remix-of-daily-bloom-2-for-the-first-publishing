...
const translations = {
  en: {
    ...
    settingsReplayTutorial: "View tutorial",
    settingsReplayTutorialDesc: "Replay the same first-launch tour. Your tasks are not deleted.",
    tutorialDurationNote: "The tutorial takes about 3 minutes.",
    tutorialSkip: "Skip tutorial (you can view it later)",
    taskHistory: "Task history",
    taskHistoryHint: "Past days with tasks. Add any item back to Today.",
    ...
    memoScan: "Read text from photo",
    memoCalculator: "Calculator",
    memoInsertResult: "Insert into memo",
  ...
  ja: {
    ...
    settingsReplayTutorial: "チュートリアルを見る",
    settingsReplayTutorialDesc: "初回起動と同じ案内をもう一度表示します。今日のタスクは消えません。",
    tutorialDurationNote: "チュートリアルは3分程度です。",
    tutorialSkip: "チュートリアルを飛ばす（後で確認できます）",
    taskHistory: "タスクの履歴",
    taskHistoryHint: "過去のタスクを日ごとに確認し、今日のリストへ追加できます。",
    ...
    memoBullets: "箇条書き",
    memoNumbers: "番号リスト",
    memoScan: "写真から文字を読み取る",
    memoCalculator: "電卓",
    memoInsertResult: "メモに貼る",
