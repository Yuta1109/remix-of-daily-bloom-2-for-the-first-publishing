...
const translations = {
  en: {
    ...
    liveActivityForegroundNote: "Tap the reminder notification to show the countdown on your Lock Screen. The timer updates automatically once started.",
    la24h: "1 day before",
  ...
  ja: {
    ...
    liveActivityForegroundNote: "通知をタップするとロック画面にカウントダウンが表示されます。表示後はタイマーが自動で更新されます。",
    la24h: "1日前",
    la12h: "12時間前",
    la8h: "8時間前",
    la6h: "6時間前",
