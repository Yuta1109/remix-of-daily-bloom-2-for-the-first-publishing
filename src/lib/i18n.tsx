...
const translations = {
  en: {
    ...
    liveActivityForegroundNote: "Starts when you open the app within the selected time before the event. You’ll also get a reminder notification at that time.",
    la24h: "1 day before",
  ...
  ja: {
    ...
    liveActivityForegroundNote: "選択した時間前以内にアプリを開くと表示が始まります。そのタイミングで通知も届きます。",
    la24h: "1日前",
    la12h: "12時間前",
    la8h: "8時間前",
    la6h: "6時間前",
